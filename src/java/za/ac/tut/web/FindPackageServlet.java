 ...
 * @author Proline
 */
public class FindPackageServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       //
       AutoDetailPackage pakgs=packageFacade.findPackage(pacId);
       //
       String location = "NotPackageFound.jsp";
       if(pakgs != null){
           //
           location="FindPackage.jsp";
           //
           request.setAttribute("pakgs", pakgs);
       }
